...
ERR_LOG=$((
(
# echo "env/bin/python3 $OSIRIS_PATH/runModel.py $REMOTE_MODEL_NAME $INPUT_PATH/$MODEL_INPUT_FILE_NAME $OUTPUT_PATH/$MODEL_OUTPUT"
env/bin/python3 "$OSIRIS_PATH"/runModel.py "$REMOTE_MODEL_NAME" "$INPUT_PATH/$MODEL_INPUT_FILE_NAME" "$OUTPUT_PATH/$MODEL_OUTPUT"
