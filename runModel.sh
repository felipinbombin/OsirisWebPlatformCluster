...
# save model answer
ssh -i "$SSH_PATH"/id_rsa "$REMOTE_USER"@"$OSIRIS_WEB_IP" "$REMOTE_PYTHON_COMMAND $REMOTE_RESPONSE_PYTHON_FILE $EXECUTION_ID $MODEL_OUTPUT \"${OUT_LOG:0:10000}\" \"$ERR_LOG\""
